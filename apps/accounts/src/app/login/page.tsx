...
import { Bird, Mail, Loader2 } from "lucide-react";
import { Button, Card, CardContent, CardHeader, CardTitle, Input, Label, Separator } from "@walletcrow/ui";
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Sign in to your WalletCrow account
          </p>
        </div>
        ...
        <p className="text-center text-sm text-muted-foreground">
          ...
          <Link href={`/signup${redirectTo !== `${DOMAINS.app}/` ? `?redirect_to=${encodeURIComponent(redirectTo)}` : ""}`} className="text-primary hover:underline font-medium">
            Create one
          </Link>
        </p>
